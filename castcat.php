...
<div class="col-8" >
        ...
        <div class="card-body">
          ...
          <div class="form-group">
            <div class="form-label-group">
              ...
              <input type="text" name="catname" class="form-control" placeholder="Category Name" required="required" autofocus="autofocus" value="<?php echo $r[1];?>">
              </div>
              </div>
              <div class="form-group">
            <div class="form-label-group">
              <label>Category Quota:(in %)</label>
              <input type="text" name="catquota" class="form-control" placeholder="Category Quota" required="required" autofocus="autofocus" value="<?php echo $r[2];?>">
              </div>
              </div>
         
              <input type="hidden" name="catid" value="<?php echo $id;?>">
             <button class="btn btn-primary btn-sm" type="submit" name="btnsub">Save Category</button>
              </div>
          </div>
        </div>
         </form></br></br>
        ...
        <thead class="thead-light">
         ...
         <th scope="col">Category Quota(in %)</th>
    ...
    <input type="hidden" name="" value="<?php echo $r[0];?>">
      <td><?php echo $r[1];?></td>
      <td><?php echo $r[2];?></td>
      <td><a href="castcat.php?catid=<?php echo $r[0];?>"><button type="button" class="btn btn-primary btn-sm" name="btnedit">Edit</button></a></td>
      <td><form action="deletecat.php" method="POST"><button type="submit" class="btn btn-primary btn-sm" name="btndelete" value="<?php echo $r[0];?>">Delete</button></form></td>
      </tr>
      <?php
        }
        ?>
...
<?php
      ...
      ?>
        ...
        <div class="card-header">Category</div>
        <div class="card-body">
          <form method="POST" action="castcat1.php">
          
          <div class="form-group">
            <div class="form-label-group">
              <label>Category Name:</label>
              <input type="text" name="catname" class="form-control" placeholder="Category Name" required="required" autofocus="autofocus">
              </div>
              </div>
               <div class="form-group">
            <div class="form-label-group">
              <label>Category Quota:(in %)</label>
              <input type="text" name="catquota" class="form-control" placeholder="Category Quota" required="required" autofocus="autofocus">
              </div>
              </div>
