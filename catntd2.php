...
$prop=array('HeaderColor'=>array(255,150,100),
			...
			'padding'=>2);
	$pdf->Table("select pinfo.r_id, cands.regino, upper(concat (lname,' ',fname,' ',mname)) as Name, castcat, percentage, edugap, subject,clgname from pinfo, academic,cands where edugap='No' and pinfo.r_id=academic.r_id and academic.r_id = cands.r_id and castcat='NT-D' and clgname='Other'  and subject='Physics,Chemistry,Maths,Statistics' and cands.regino in(select regino from verify where status='verified') ORDER BY percentage desc;",$prop);
