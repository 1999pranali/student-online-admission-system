...
<html lang="en">
 ...
 <div class="col-8" >
         <?php
          ...
          $id=$_GET['did'];
          if(isset($id)){
          $q="select * from district where district_id=$id;";
        ...
        <div class="card-body">
          ...
          <div class="form-group">
            <div class="form-label-group">
              ...
              <input type="text" name="dname" class="form-control" placeholder="District Name" required="required" autofocus="autofocus" value="<?php echo $r[1];?>">
              </div>
              </div>
              <input type="hidden" name="did" value="<?php echo $id;?>">
               
             <button class="btn btn-primary btn-sm" type="submit" name="btnsub">Save District</button>
              </div>
          </div>
          </div>
         </form></br></br>
    ...
    <input type="hidden" name="" value="<?php echo $r[0];?>">
      <td><?php echo $r[1];?></td>
      <td><a href="district.php?did=<?php echo $r[0];?>"><button type="button" class="btn btn-primary btn-sm" name="btnedit">Edit</button></a></td>
      <td><form action="deletedis.php" method="POST"><button type="submit" class="btn btn-primary btn-sm" name="btndelete" value="<?php echo $r[0];?>">Delete</button></form></td>
      </tr>
      <?php
        }
        ?>
...
<?php
      ...
      ?>
        ...
        <div class="card-header">District</div>
        <div class="card-body">
          <form method="POST" action="district1.php">
          <div class="form-group">
            <div class="form-label-group">
              <label>District Name:</label>
              <input type="text" name="dname" class="form-control" placeholder="District Name" required="required" autofocus="autofocus">
              </div>
              </div>
             <button class="btn btn-primary btn-sm" type="submit" name="btnsub">Save District</button>
              </div>
