...
<body >
   <div class="form1"><br><br>
      <div>
        ...
        <div style="text-align: center;"><b> Create your own Username and Password</b></div><br><br>
 <form action="saveregi1.php" method="POST">
 
   <img src="image/a1.png" style="size: 3px; width:6%; height:1%;"> <label>Username:</label>
    <input type="text" class="form" name="uname"><br><br>
  </div>
  <div>
    <img src="image/a3.jpg" style="size: 3px; width: 6%; height: 1%"><label> Password:</label>
    <input type="password" class="form" name="pass"><br><br>
  </div>
  <div>
    <button type="submit"  class="button1" name="btnsub">Register</button>
    </form> 
  </div><br>
