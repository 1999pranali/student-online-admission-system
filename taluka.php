...
<html lang="en">
 ...
 <div class="col-8" >
        <?php
          ...
          $id=$_GET['tid'];
          if(isset($id)){
          $q="select * from taluka where t_id=$id;";
        ...
        <div class="card-body">
          <form method="POST" action="edittaluka.php">
          <div class="form-group">
            <div class="form-label-group">
              <label>Taluka Name:</label>
              <input type="text" name="tname" class="form-control" placeholder="Taluka Name" required="required" autofocus="autofocus" value="<?php echo $r[1];?>">
              </div>
              </div>
              <input type="hidden" name="tid" value="<?php echo $id;?>">
             <button class="btn btn-primary btn-sm" type="submit" name="btnsub">Save Taluka</button>
              </div>
          </div>
          </div>
    ...
    <input type="hidden" name="" value="<?php echo $r[0];?>">
      <td><?php echo $r[1];?></td>
      <td><a href="taluka.php?tid=<?php echo $r[0];?>"><button type="button" class="btn btn-primary btn-sm" name="btnedit">Edit</button></a></td>
      <td><form action="deletetaluka.php" method="POST"><button type="submit" class="btn btn-primary btn-sm" name="btndelete" value="<?php echo $r[0];?>">Delete</button></form></td>
      </tr>
      <?php
        }
        ?>
...
<?php
      ...
      ?>
        ...
        <div class="card-header">Taluka</div>
        <div class="card-body">
          <form method="POST" action="taluka1.php">
          <div class="form-group">
            <div class="form-label-group">
              <label>Taluka Name:</label>
              <input type="text" name="tname" class="form-control" placeholder="Taluka Name" required="required" autofocus="autofocus">
              </div>
              </div>
             <button class="btn btn-primary btn-sm" type="submit" name="btnsub">Save Taluka</button>
              </div>
