...
$id=$_GET['rid'];
if(isset($id)){
  $q="select * from religions where r_id=$id;";
...
?>
       <div class="container">
        ...
        <div class="card-body">
           <form method="POST" action="editrel.php">
          <div class="form-group">
            <div class="form-label-group">
              <label>Religion Name:</label>
              <input type="text" name="rname" class="form-control" placeholder="Religion Name" required="required" autofocus="autofocus" value="<?php echo $r[1];?>">
              </div>
              </div>
               <input type="hidden" name="rid" value="<?php echo $id;?>">
             <button class="btn btn-primary btn-sm" type="submit" name="btnsub">Save Religion</button>
              </div>
          </div>
          </div>
           </form></br></br>
    ...
    <input type="hidden" name="" value="<?php echo $r[0];?>">
      <td><?php echo $r[1];?></td>
      <td><a href="religion.php?rid=<?php echo $r[0];?>"><button type="button" class="btn btn-primary btn-sm" name="btnedit">Edit</button></a></td>
      <td><form action="deleterel.php" method="POST"><button type="submit" class="btn btn-primary btn-sm" name="btndelete" value="<?php echo $r[0];?>">Delete</button></form></td>
      </tr>
      <?php
        }
        ?>
...
<?php
      ...
      ?>
       <div class="container">
        ...
        <div class="card-header">Religion</div>
        <div class="card-body">
          <form method="POST" action="religion1.php">
          <div class="form-group">
            <div class="form-label-group">
              <label>Religion Name:</label>
              <input type="text" name="rname" class="form-control" placeholder="Religion Name" required="required" autofocus="autofocus">
              </div>
              </div>
             <button class="btn btn-primary btn-sm" type="submit" name="btnsub">Save Religion</button>
              </div>
