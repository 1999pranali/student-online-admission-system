	 ...
	 $q="select cat_name,cat_quota from category order by cat_name asc;";
             ...
             while($rr=mysqli_fetch_array($res))
           {
            ...
            //echo $ss1;
              ...
              //print_r($cat);
              $quota="insert into gpoint(g_name,cat1,cat2,cat3,cat4,cat5,cat6,cat7,cat8,cat9,cat10) values('$sid','$ca[0]','$ca[1]','$ca[2]','$ca[3]','$ca[4]','$ca[5]','$ca[6]','$ca[7]','$ca[8]','$ca[9]');";
	 ...
	 $qq1="select cat_name,cat_quota from category order by cat_name asc;";
             ...
             while($rr1=mysqli_fetch_array($res1))
           {
            ...
            //echo $ss1;
              ...
              //print_r($cat);
              $insertquota="insert into gtotal(g_name,cat1,cat2,cat3,cat4,cat5,cat6,cat7,cat8,cat9,cat10) values('$sid','$cat[0]','$cat[1]','$cat[2]','$cat[3]','$cat[4]','$cat[5]','$cat[6]','$cat[7]','$cat[8]','$cat[9]');";
              ...
              while($rr2=mysqli_fetch_array($res1))
           {
            ...
            //echo $ss1;
             ...
             // print_r($cat);
              $insertquota2="insert into gvck(g_name,cat1,cat2,cat3,cat4,cat5,cat6,cat7,cat8,cat9,cat10) values('$sid','$catt[0]','$catt[1]','$catt[2]','$catt[3]','$catt[4]','$catt[5]','$catt[6]','$catt[7]','$catt[8]','$catt[9]');";
                ...
                while($rr3=mysqli_fetch_array($res1))
           {
            ...
            array_push($cat3, $ssss3);
              ...
              $insertquota3="insert into gother(g_name,cat1,cat2,cat3,cat4,cat5,cat6,cat7,cat8,cat9,cat10) values('$sid','$cat3[0]','$cat3[1]','$cat3[2]','$cat3[3]','$cat3[4]','$cat3[5]','$cat3[6]','$cat3[7]','$cat3[8]','$cat3[9]');";
