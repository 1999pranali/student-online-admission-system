...
<div class="col-8" >
 <br>
<div><h4>Nongrantable Merit List Criteria</h4></div>
...
<br>
  ...
  <tr>
    <?php
            include("connection.php");
            $q1="select g_name,max(time) from npoint group by g_name desc ;";
            $result1=mysqli_query($con,$q1);
             while($r1=mysqli_fetch_row($result1))
           {
            

                $q="select g_name,cat1,cat2,cat3,cat4,cat5,cat6,cat7,cat8,cat9,cat10 from npoint where g_name='$r1[0]' and time='$r1[1]' ;";
                $result=mysqli_query($con,$q);
          ...
          <tr>
           <?php
                ...
                $q2="select g_name,cat1,cat2,cat3,cat4,cat5,cat6,cat7,cat8,cat9,cat10 from ntotal where g_name='$r1[0]' and time='$r1[1]' and g_name='$r[0]' ;";
         ...
         <tr>
           <?php
                ...
                $q3="select g_name,cat1,cat2,cat3,cat4,cat5,cat6,cat7,cat8,cat9,cat10 from nvck where g_name='$r1[0]' and time='$r1[1]' and g_name='$r[0]';";
         ...
         <tr> <th>VCK</th>
          ...
          <tr>
           <?php
                ...
                $q4="select g_name,cat1,cat2,cat3,cat4,cat5,cat6,cat7,cat8,cat9,cat10 from nother where g_name='$r1[0]' and time='$r1[1]' and g_name='$r[0]';";
