  ...
  <div class="header" style="text-align: center; width: 100%; height: 80px; display: block; background-color: gray; color: white; padding-top: 10px; ">
   ...
   <div class="row">
        ...
        <ul>
          ...
          </li><li class="nav-item dropdown"><a>Address</a>
 ...
 <div class="col-8" >
  ...
  if(isset($_GET['cid']))
  {
        ...
        <div class="card-body">
          ...
          <div class="form-group">
            <div class="form-label-group">
              ...
              <input type="text" name="cname" class="form-control" placeholder="Course Name" required="required" autofocus="autofocus" value="<?php echo $r[1];?>">
              </div>
              </div>
               <input type="hidden" name="cid" value="<?php echo $id;?>">
                <button class="btn btn-primary btn-sm" type="submit" name="btnsub">Save Course</button>
              </div>
          </div>
          </div>
           </form></br></br>
    ...
    <input type="hidden" name="" value="<?php echo $r[0];?>">
      <td><?php echo $r[1];?></td>
      <td><a href="course.php?cid=<?php echo $r[0];?>"><button type="button" class="btn btn-primary btn-sm" name="btnedit">Edit</button></a></td>
      <td><form action="deletecourse.php" method="POST"><button type="submit" class="btn btn-primary btn-sm" name="btndelete" value="<?php echo $r[0];?>">Delete</button></form></td>
      </tr>
      <?php
        }
        ?>
        ...
        <div class="card-body">
          ...
          <div class="form-group">
            <div class="form-label-group">
              ...
              <label>Course Name:</label>
              <input type="text" name="cname" class="form-control" placeholder="Course Name" required="required" autofocus="autofocus">
              </div>
              </div>
               <button class="btn btn-primary btn-sm" type="submit" name="btnsub">Save Course</button>
              </div>
