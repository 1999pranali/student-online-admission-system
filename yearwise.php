...
<html lang="en">
  ...
  <div class="header" style="text-align: center; width: 100%; height: 80px; display: block; background-color: gray; color: white; padding-top: 10px; ">
   ...
   <div class="row">
        ...
        <div class="card-header">Yearwise General Merit List</div>
        <div class="card-body">
          <form action="yearwise1.php" method="POST">
            <div class="form-group">
            <div class="form-label-group">
               <div>Select Admission Year:</div></br>

              <select  name="ayear" class="form-control"  required="required" autofocus="autofocus">
                <?php
      ...
      <!--    <div> Previous College Name:</div>
         <div class="form-group">
            <div class="form-label-group">
                <select  name="name" class="form-control"  required="required" autofocus="autofocus" >
            
               <option value="All_Over" name="all" >All Over</option>;
