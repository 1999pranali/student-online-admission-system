...
{
	$ayear=$_POST['ayear'];
	$a="insert into acayear(ayear) values('$ayear');";
...
<div class="col-8" >
        ...
        <div class="card-header">Admission Year</div>
        <div class="card-body">
          <form method="POST" action="ayear.php">
          
          <div class="form-group">
            <div class="form-label-group">
              <label>Admission Year:</label>
              <input type="text" name="ayear" class="form-control" placeholder="Admission Year" required="required" autofocus="autofocus">
              </div>
              </div>
               
             <button class="btn btn-primary btn-sm" type="submit" name="btnsub">Save Admission Year</button>
              </div>
          </div>
        </div>
         </form></br></br>
      ...
      <td><form action="deleteayear.php" method="POST"><button type="submit" class="btn btn-primary btn-sm" name="btndelete" value="<?php echo $r[0];?>">Delete</button></form></td>
      </tr>
      <?php
        }
        ?>
