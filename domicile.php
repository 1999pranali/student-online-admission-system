...
<div class="col-8" >
          ...
          if(isset($_GET['domid']))
  {
          ...
          $id=$_GET['domid'];
          if(isset($id)){
          $q="select * from domicile where domicile_id=$id;";
          $result=mysqli_query($con,$q);
           $r=mysqli_fetch_row($result);
           ?>
        <div class="container">
        <div class="card card-login mx-auto mt-5">
        <div class="card-header">Domicile State</div>
        <div class="card-body">
          <form method="POST" action="editdom.php">
          <div class="form-group">
            <div class="form-label-group">
              <label>Domicile State Name:</label>
              <input type="text" name="domname" class="form-control" placeholder="Domicile State Name" required="required" autofocus="autofocus" value="<?php echo $r[1];?>">
              </div>
              </div>
              <input type="hidden" name="domid" value="<?php echo $id;?>">
             <button class="btn btn-primary btn-sm" type="submit" name="btnsub">Save State</button>
              </div>
          </div>
          </div>
        </form></br></br>
        ...
        <thead class="thead-light">
         <tr>
         <th scope="col">Domicile State Name</th>
    ...
    <input type="hidden" name="" value="<?php echo $r[0];?>">
      <td><?php echo $r[1];?></td>
      <td><a href="domicile.php?domid=<?php echo $r[0];?>"><button type="button" class="btn btn-primary btn-sm" name="btnedit">Edit</button></a></td>
      <td><form action="deletedom.php" method="POST"><button type="submit" class="btn btn-primary btn-sm" name="btndelete" value="<?php echo $r[0];?>">Delete</button></form></td>
      </tr>
      <?php
        }
        ?>
...
<?php
      ...
      ?>
          <div class="container">
        <div class="card card-login mx-auto mt-5">
        <div class="card-header">Domicile State Name</div>
        <div class="card-body">
          <form method="POST" action="domicile1.php">
          <div class="form-group">
            <div class="form-label-group">
              <label>Domicile State Name:</label>
              <input type="text" name="domname" class="form-control" placeholder="Domicile Name" required="required" autofocus="autofocus">
              </div>
              </div>
             <button class="btn btn-primary btn-sm" type="submit" name="btnsub">Save State</button>
              </div>
