...
<html lang="en">
      ...
      if(isset($_GET['sid']))
  {
      $id=$_GET['sid'];
      if(isset($id)){
      $q="select * from subcat where scat_id=$id;";
        ...
        <div class="card-body">
          ...
          <div class="form-group">
            <div class="form-label-group">
              ...
              <input type="text" name="subname" class="form-control" placeholder="Subcategory Name" required="required" autofocus="autofocus" value="<?php echo $r[1];?>">
              </div>
              </div>
               <input type="hidden" name="sid" value="<?php echo $id;?>">
             <button class="btn btn-primary btn-sm" type="submit" name="btnsub">Save Subcategory</button>
              </div>
          </div>
          </div>
          </form></br></br>
    ...
    <input type="hidden" name="" value="<?php echo $r[0];?>">
      <td><?php echo $r[1];?></td>
      <td><a href="subcast.php?sid=<?php echo $r[0];?>"><button type="button" class="btn btn-primary btn-sm" name="btnedit">Edit</button></a></td>
      <td><form action="deletesub.php" method="POST"><button type="submit" class="btn btn-primary btn-sm" name="btndelete" value="<?php echo $r[0];?>">Delete</button></form></td>
      </tr>
      <?php
        }
        ?>
...
<?php
      ...
      ?>
        ...
        <div class="card-header">Subcategory</div>
        <div class="card-body">
          <form method="POST" action="subcast1.php">
          <div class="form-group">
            <div class="form-label-group">
              <label>Subcategory Name:</label>
              <input type="text" name="subname" class="form-control" placeholder="Subcategory Name" required="required" autofocus="autofocus">
              </div>
              </div>
             <button class="btn btn-primary btn-sm" type="submit" name="btnsub">Save Subcategory</button>
              </div>
