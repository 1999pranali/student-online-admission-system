...
<html lang="en">
 ...
 <div class="col-8" >
        <?php
          ...
          $id=$_GET['stateid'];
          if(isset($id)){
          $q="select * from state where state_id=$id;";
        ...
        <div class="card-body">
          ...
          <div class="form-group">
            <div class="form-label-group">
              ...
              <input type="text" name="statename" class="form-control" placeholder="State Name" required="required" autofocus="autofocus" value="<?php echo $r[1];?>">
              </div>
              </div>
    ...
    <input type="hidden" name="" value="<?php echo $r[0];?>">
      <td><?php echo $r[1];?></td>
      <td><a href="state.php?stateid=<?php echo $r[0];?>"><button type="button" class="btn btn-primary btn-sm" name="btnedit">Edit</button></a></td>
      <td><form action="deletestate.php" method="POST"><button type="submit" class="btn btn-primary btn-sm" name="btndelete" value="<?php echo $r[0];?>">Delete</button></form></td>
      </tr>
      <?php
        }
        ?>
...
<?php
      ...
      ?>
        ...
        <div class="card-header">State</div>
        <div class="card-body">
          <form method="POST" action="state1.php">
          <div class="form-group">
            <div class="form-label-group">
              <label>State Name:</label>
              <input type="text" name="statename" class="form-control" placeholder="State Name" required="required" autofocus="autofocus">
              </div>
              </div>
             <button class="btn btn-primary btn-sm" type="submit" name="btnsub">Save State</button>
              </div>
